...
config_pri_assets {
    OTHER_FILES += \
        ...
        $$quote($$BASEDIR/assets/JsonItem.qml) \
        $$quote($$BASEDIR/assets/JsonListView.qml) \
        $$quote($$BASEDIR/assets/JsonPage.qml) \
        $$quote($$BASEDIR/assets/bicing.json) \
        $$quote($$BASEDIR/assets/bucket.json) \
